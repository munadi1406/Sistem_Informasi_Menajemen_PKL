...
export default function KartuPelajar() {
  ...
  return (
    <div className="bg-white rounded-md px-2 py-3 flex flex-col gap-4 -h-max">
      ...
      <TransformWrapper minScale={0.4} disabled={canvasActive}>
        <TransformComponent>
          <div
            className="certificate w-max relative h-max border-red-600 border-2"
            ref={ref}
          >
            {value.template && imageBlob && splitName && (
              <>
                <LazyImage
                  ...
                  alt={"image"}
                  className="w-[29.7cm] h-[21cm] border-blue-600 border-2"
