            ...
            <table className="border-collapse border border-black w-full">
              <thead>
                <tr>
                  ...
                  <th className="border border-black py-2">Pengirim</th>
                  <th className="border border-black py-2">Perihal</th>
                  <th className="border border-black py-2">Tanggal Masuk</th>
                </tr>
              </thead>
              ...
              <tbody>
                {data.data.pages.map(({ data }) =>
                  data.data.data.map(
                    ({ nomorSurat, pengirim, perihal, tanggalMasuk }, i) => (
                      <tr key={i}>
                        ...
                        <td className={"border border-black p-1"}>
                          {new Date(tanggalMasuk).toLocaleDateString("en-GB")}
                        </td>
                      </tr>
                    ),
                  ),
