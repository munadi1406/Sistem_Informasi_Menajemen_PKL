...
import {
  storeTemplateSertifkat,
  updateTemplateSertifkat,
} from "../../../api/templateSertifkat";
      ...
      <form className="space-y-2" onSubmit={handleSubmit}>
        ...
        {isEdit && (
          <div>
            ...
            <img
              src={`${endpoint}/templateSertifikat/image/${dataTemplate?.template}`}
              className="w-full h-auto rounded-md"
              loading="eager"
              alt={dataTemplate?.name}
            />
          </div>
        )}
        ...
        <ButtonCustom
          text={
            isLoading || handleEditTemplate.isLoading ? <Loader /> : "Simpan"
          }
          type="submit"
        />
      </form>
